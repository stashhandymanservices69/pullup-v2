...
function PulseDashboard({ user, profile }: { user: any; profile: any }) {
    ...
    return (
      <div className="space-y-5">
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <Metric icon="⭐" label="Early Adopters" value={`${m.ea}/250`} sub={`${250 - m.ea} slots left (per country)`} color={P.amber} info="First 250 cafe partners per country get Early Adopter benefits: $0.25/order rebate. Self-signup = 12 months. Affiliate-referred = 11 months (after 30-day affiliate window). Must show activity within 30 days of approval." />
  ...
  const knowledgeBase = useMemo(() => [
    ...
    { id: 'early-adopter', keywords: ['early adopter', 'founders', 'first 250', 'first 100', 'first 33', 'special', 'benefit', 'bonus', 'early bird'], text: 'Fast answer: the first 250 cafe partners per country are "Early Adopters" — you receive a $0.25/order rebate. Self-signup = 12 months. Referred by affiliate = 11 months (after their 30-day commission window). Must show activity within 30 days of approval to keep your spot. Standard Stripe processing applies as a normal business cost.' },
